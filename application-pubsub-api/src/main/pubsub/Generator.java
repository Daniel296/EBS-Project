...
public class Generator
{
    ...
    public static String getRandomDate()
    {
        ...
        return Date.valueOf(LocalDate.of(year, month, day)).toString();
    }

    public static String getRandomHeight()
    {
        return Double.toString(Double.parseDouble("1." + getRandomNumber(55, 99)));
    }
    ...
    {
        return Integer.toString(getRandomNumber(50, 120));
    }

    public static String getRandomOperator()
    {
        return Integer.toString(getRandomNumber(0, 6));
    }

    public static String getRandomNameOperator()
    {
        return Integer.toString(getRandomNumber(0, 2));
    }
